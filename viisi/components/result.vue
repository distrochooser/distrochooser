<template lang="pug">
  div.result(:class="{'compact-result': compactView}")
    ...
    distribution(aria-role="list-item", v-for="(selection, selection_key) in selections", :ratings="selection.distro.ratings", :positive_ratings="selection.distro.positive_ratings", :key="selection_key",:percentage="selection.percentage", :rank="selection.rank", :name="selection.distro.name", :description="selection.distro.description", :reasons="selection.reasons", :fgColor="$store.state.visuallyImpairedMode ? 'white' :  selection.distro.fgColor", :bgColor="$store.state.visuallyImpairedMode ? 'black' : selection.distro.bgColor", :id="selection.distro.identifier", :tags="selection.tags", :selection="selection.selection", :url="selection.distro.url", :class="{'compact-distribution': compactView}")
