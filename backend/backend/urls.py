...
from distrochooser.views import start, load_question, submit_answers, get_locales, vote, get_given_answers, update_remark, get_ssr_data, get_language_values, get_stats, get_feedback, process_feedback, register_click, store_requirements, public_stats
...
urlpatterns = [
    ...
    path('stats/'.format(system_suffix), public_stats, name="public_stats"),
